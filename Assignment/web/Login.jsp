<%-- 
    Document   : Login
    Created on : Apr 13, 2022, 2:16:40 PM
    Author     : DPV
--%>
                ...
                <div class="col-md-4 offset-md-4 mt-5">
                    <div class="card">
                        <form class="card-body p-lg-5" style="background-color: #ebf2fa;" action="login" method="POST">
                            ...
                            <div class="mb-3">
                                <input type="checkbox" id="remeberme" name="remeberme"><label>Remember</label>
                            </div>
                            <div class="text-center"><button type="submit" class="px-5 mb-5 w-100" style="background-color: #0e1c36; color: #fff;">Login</button></div>
                        </form>
                    </div>
                </div>
